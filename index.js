...
const salad = createMenuItem("salad", 10, "dinner");
const pizza = createMenuItem("pizza", 12, "breakfast");
...
*/
reviews.push({ name: 'Pete', rating: 5, feedback: 'I loved it more than life itself' });
